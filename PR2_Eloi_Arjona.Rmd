...
**Antiguita**t: Variable fonamental per a l'Anàlisi de Depreciació. Ens permet segmentar el dataset en cotxes "Nous", "Semi-nous" i "Vells".
...
**Preu perkm**: Relaciona el valor residual del cotxe amb el seu ús. Els cotxes amb un valor molt baix aquí són els que més s'han devaluat per quilòmetre recorregut.
